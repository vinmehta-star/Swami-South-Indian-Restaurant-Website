...
<section class="about-page">
  ...
  <img src="images/about-food.jpg" alt="Our Chef cooking" class="about-image" onerror="this.style.display='none'">
  
  <p>
    Welcome to <strong>SWAMI</strong>, where tradition meets taste. Established in the heart of Mumbai, 
    we have been serving authentic South Indian delicacies for over a decade.
  </p>
